...
const DestinationPage = () => {
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-2xl font-bold mt-6">Explore Different Destinations</h2>
      <p className="mb-6">Discover the beauty and adventure that Kenya has to offer. From stunning landscapes to vibrant cultures, there's something for everyone.</p>
